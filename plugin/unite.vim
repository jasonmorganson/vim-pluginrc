...
nnoremap <silent> [unite]d       :<C-u>UniteWithProjectDir -buffer-name=files file<cr>
...
nnoremap <silent> [unite]j       :<C-u>Unite -buffer-name=jump     buffer         -auto-resize -quick-match<cr>
...
nnoremap <silent> [unite]m       :<C-u>Unite -buffer-name=marks    mark           -auto-resize <cr>
